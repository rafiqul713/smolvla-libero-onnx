...
_Generated 2026-08-27T20:49:04Z • tether 0.12.0 @ _

## Per-chunk latency (post-warmup)

- **n** = 1000 samples (warmup_discarded = 0)
- **min** = 468.48 ms
- **mean** = 497.50 ms (95% CI [496.80, 498.20])
- **p50** = 498.15 ms
- **p95** = 516.19 ms
- **p99** = 532.28 ms
- **p99.9** = 549.15 ms
- **max** = 549.45 ms
- **std** = 11.27 ms
- **jitter** (std/mean) = 0.0227
- **hz** (1/mean) = 2.0 Hz

## Reproducibility envelope

- **timestamp**: `2026-08-27T20:49:04Z`
- **tether**: `0.12.0`
- **git**: ``
- **python**: `3.12.13`
...
- **seed**: `0`
- **export_dir**: `exports/smolvla_libero_int8`
